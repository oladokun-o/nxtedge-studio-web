const solutionDetails = [
  {
    ...
    icon: "code",
    overview: "Most business websites are brochures — they describe the business but don't do any of the work. We build the other kind: web applications and platforms that are part of how your business actually runs, from customer-facing sites to internal dashboards.",
    businessProblems: [
  ...
  },
  {
    ...
    icon: "smartphone",
    overview: "When your team or your customers need access on the move, a website is the wrong tool. We build mobile apps — for staff running field operations, or customers who expect to reach you from their phone first.",
    businessProblems: [
  ...
  },
  {
    ...
    icon: "layers",
    overview: "Most operational bottlenecks aren't a people problem — they're a missing-system problem. We build the internal tools that replace spreadsheets, WhatsApp threads, and tribal knowledge with something structured and reliable.",
    businessProblems: [
  ...
  },
  {
    ...
    icon: "sparkles",
    overview: "AI is a capability we build into real systems, not a label we put on a pitch deck. Where structuring, summarizing, or classifying information is slowing your team down, we build it into your existing workflow — the same discipline behind Nxtflo, our own internal AI-powered delivery system.",
    businessProblems: [
  ...
  },
  {
    ...
    icon: "cloud",
    overview: "Nxtedge Studio isn't only software — we handle the physical infrastructure underneath it too. Networking, CCTV, and cloud hosting, planned as one system instead of three separate vendors who don't talk to each other.",
    businessProblems: [
